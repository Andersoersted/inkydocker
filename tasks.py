...
from utils.ai_models import get_clip_model, get_image_embedding, generate_tags_and_description
...
#==============================================================================
# CELERY TASKS - Image Processing & AI Tagging
#==============================================================================
...
def send_scheduled_image(event_id):
    ...
    with flask_app.app_context():
        ...
        from utils.database import load_crop_info_from_db, add_send_log_entry
        from flask import current_app
